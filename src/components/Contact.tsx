              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="font-medium group-hover:text-primary transition-colors">somenjeet2004@gmail.com</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="font-medium group-hover:text-primary transition-colors">+91 9546764006</div>
                  </div>
                </a>
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-lg bg-card border border-border">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <a href="https://github.com/somenjeet01" target="_blank" rel="noopener noreferrer">
                  ...
                  <Button 
                    ...
                    className="w-full justify-start border-border hover:border-primary hover:bg-transparent"
                  >
                    <a href="https://linkedin.com/in/somen-jeet-562044259/" target="_blank" rel="noopener noreferrer">
